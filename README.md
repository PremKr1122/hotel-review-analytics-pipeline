...
structured sentiment and aspect-level insights, loaded into MySQL and ready
...
5. **Power BI dashboard** *(in progress)* — visualizes sentiment trends
   and aspect-level insights across cities and hotels.
...
Ingestion, cleaning, NLP, and MySQL loading are complete. Power BI
